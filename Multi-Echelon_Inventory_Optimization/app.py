...
#
store_df.to_excel("store_aggregated_monthly_demand.xlsx", index=False, engine='openpyxl')
store_demand_df=store_data(store_df)
store_demand_df.to_excel("store_total_demand_df.xlsx",index=False,engine='openpyxl')

warehouse_df.to_excel("warehouse_aggregated_monthly_demand.xlsx", index=False, engine='openpyxl')
warehouse_demand_df=warehouse_data(warehouse_df)
warehouse_demand_df.to_excel("warehouse_total_demand_df.xlsx",index=False,engine='openpyxl')

dc_df.to_excel("dc_aggregated_monthly_demand.xlsx", index=False, engine='openpyxl')
dc_demand_df=dc_data(dc_df)
dc_demand_df.to_excel("dc_total_demand_df.xlsx",index=False,engine='openpyxl')
